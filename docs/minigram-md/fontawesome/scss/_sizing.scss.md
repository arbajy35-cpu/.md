...
- Path: `fontawesome/scss/_sizing.scss`
- Extension: `.scss`
- Size: 308 bytes
- Lines: 17
...
- // sizing icons // ------------------------- // literal magnification scale @for $i from 1 through 10
- -#
- x
- // step-based scale (with alignment) @each $size, $value in $fa-sizes
