...
| Property | Value |
|---|---|
| Source | `fontawesome/metadata/icon-families.yml` |
| Extension | `.yml` |
| Size | 837473 bytes |
| Lines | 53596 |
| SHA-256 | `58564c9b11391594378998007a67765703c78ce0d8e4f0d83c757fa1d56914ed` |
...
`/storage/emulated/0/MINIGRAM1/fontawesome/metadata/icon-families.yml`
