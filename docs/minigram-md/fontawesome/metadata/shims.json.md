...
| Property | Value |
|---|---|
| Source | `fontawesome/metadata/shims.json` |
| Extension | `.json` |
| Bytes | 40658 |
| Lines | 4052 |
| SHA-256 | `259250fe53f3c650a1bd464d2e809cce7f9bf8e91cb7add3005de37a9b9c2fea` |
| Dependency Depth | 0 |
...
`/storage/emulated/0/MINIGRAM1/fontawesome/metadata/shims.json`
