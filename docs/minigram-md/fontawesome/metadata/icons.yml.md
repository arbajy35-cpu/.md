...
| Property | Value |
|---|---|
| Source | `fontawesome/metadata/icons.yml` |
| Extension | `.yml` |
| Bytes | 614095 |
| Lines | 43739 |
| SHA-256 | `a2cccbbaffe6bb7c72f97ddeaaa0a06d71c276cff22fe7a04a7f92e774136d99` |
| Dependency Depth | 0 |
...
`/storage/emulated/0/MINIGRAM1/fontawesome/metadata/icons.yml`
