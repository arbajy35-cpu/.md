...
- /* ==================================================  MINIGRAM HOME CSS (FINAL LIGHTWEIGHT) ================================================== */ /* ===== ROOT ===== */ :root
- /* ===== GLOBAL ===== */ *
- /* ===== HTML / BODY ===== */ html, body
- /* ===== HOME ROOT � SMOOTH + CPU FRIENDLY ===== */ #homeRoot
- /* ===== FEED ===== */ .feed
- /* ===== POST � GPU/CPU FRIENDLY ===== */ .post
- /* ===== NO ANIMATION ===== */ .noAnim
- /* ===== HEADER ===== */ .postHeader
- .postHeaderLeft
- /* ===== AVATAR ===== */ .avatar
- /* ===== REMOVE SHADOW ===== */ .noShadow .avatar
- /* ===== USERNAME ===== */ .username
- /* ========================================= POST IMAGE � LIGHTWEIGHT ========================================= */ .postImageContainer
- /* ===== IMAGE � LIGHTWEIGHT ===== */ .postImage
- /* ===== ACTIONS ===== */ .postActions
- .postActionsLeft
- /* ===== BUTTON ===== */ .postActionsLeft button
- /* ===== HOVER ===== */ .postActionsLeft button:hover
- /* ===== ACTIVE ===== */ .postActionsLeft button:active
- /* ===== ICON ===== */ .postActions svg
- /* ===== REMOVE COMMENTS ===== */ .noComments .commentBtn
- /* ===== LIKES ===== */ .postLikes
- /* ===== CAPTION ===== */ .postCaption
- /* ===== CAPTION USERNAME ===== */ .postCaption b
- /* ===== TIME ===== */ .postTime
- /* ===== BOTTOM NAV ===== */ .bottomNav
- /* ===== LIGHTWEIGHT ANIMATION ===== */ @keyframes fadeIn
- to
- /* ===== MOBILE ===== */ @media (max-width: 768px)
- .postActionsLeft button
- .postActions svg
- /* ===== LOW-END DEVICES ===== */ @media (prefers-reduced-motion: reduce)
- /* =========================================  LIKE BUTTON FIX ========================================= */ .likeBtn
- .likeBtn.liked
- /*  DEFAULT HEART */ .likeBtn svg
- /*  LIKED HEART */ .likeBtn.liked svg
- .postComments
- /* ==================================================  HOME PAGE FIX - STORIES + FEED LAYOUT ================================================== */ /* ===== HOME PAGE WRAPPER ===== */ .homePage
- /* ===== STORIES SECTION - HORIZONTAL SCROLL ===== */ .stories-container
- .stories-wrapper
...
- .storyRing img
- .storyUser
- /* ===== FEED SECTION - IMPORTANT ===== */ .feed-container
- .posts-container
- /* Feed bundle ka content yahan aayega */ .posts-container > *
