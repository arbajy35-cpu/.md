...
- **[INFERRED]** Static size: 950 bytes; 56 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting auth.js, then inspect its incoming and outgoing dependency relationships.
