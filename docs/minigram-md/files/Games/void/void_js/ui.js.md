...
- **File Name:** `ui.js`
- **File Path:** `Games/void/void_js/ui.js`
- **Extension:** `.js`
- **Lines:** 46
- **Bytes:** 506
...
- **[FACT]** This source file contains 46 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 506 bytes; 46 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/void/void_js/ui.js, then inspect its incoming and outgoing dependency relationships.
...
- `addLine` — line 1
- `scrollBottom` — line 28
- `updatePrompt` — line 35
...
Source file: Games/void/void_js/ui.js.
