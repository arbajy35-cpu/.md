...
- **File Name:** `audio.js`
- **File Path:** `Games/void/void_js/audio.js`
- **Extension:** `.js`
- **Lines:** 47
- **Bytes:** 554
...
- **[FACT]** This source file contains 47 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 554 bytes; 47 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/void/void_js/audio.js, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/void/void_js/audio.js.
