...
- **File Path:** `Games/void/void_js/commands.js`
- **Extension:** `.js`
- **Lines:** 158
- **Bytes:** 1833
...
- **[FACT]** This source file contains 158 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 1833 bytes; 158 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/void/void_js/commands.js, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/void/void_js/commands.js.
