...
- **File Name:** `nano.js`
- **File Path:** `Games/void/void_js/nano.js`
- **Extension:** `.js`
- **Lines:** 52
- **Bytes:** 697
...
- **[FACT]** This source file contains 52 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 697 bytes; 52 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/void/void_js/nano.js, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/void/void_js/nano.js.
