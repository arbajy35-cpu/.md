...
- **File Name:** `carrom.html`
- **File Path:** `Games/carrom/carrom_mode/carrom_game/carrom.html`
- **Extension:** `.html`
- **Lines:** 48
- **Bytes:** 1458
...
- **[FACT]** This source file contains 48 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 1458 bytes; 48 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/carrom/carrom_mode/carrom_game/carrom.html, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/carrom/carrom_mode/carrom_game/carrom.html.
