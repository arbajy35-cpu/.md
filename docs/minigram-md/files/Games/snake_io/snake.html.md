...
- **File Name:** `snake.html`
- **File Path:** `Games/snake_io/snake.html`
- **Extension:** `.html`
- **Lines:** 25
- **Bytes:** 487
...
- **[FACT]** This source file contains 25 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 487 bytes; 25 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/snake_io/snake.html, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/snake_io/snake.html.
