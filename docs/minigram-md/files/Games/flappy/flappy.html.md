...
- **File Name:** `flappy.html`
- **File Path:** `Games/flappy/flappy.html`
- **Extension:** `.html`
- **Lines:** 19
- **Bytes:** 336
...
- **[FACT]** This source file contains 19 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 336 bytes; 19 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/flappy/flappy.html, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/flappy/flappy.html.
