...
- **File Name:** `deno.html`
- **File Path:** `Games/deno/deno.html`
- **Extension:** `.html`
- **Lines:** 1
- **Bytes:** 0
...
- **[FACT]** This source file contains 1 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 0 bytes; 1 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting Games/deno/deno.html, then inspect its incoming and outgoing dependency relationships.
...
Source file: Games/deno/deno.html.

---

# SOURCE CODE

> Source: `Games/deno/deno.html`
