...
- **File Name:** `chat-v.css`
- **File Path:** `chat/chat_view/chat-v.css`
- **Extension:** `.css`
- **Lines:** 797
- **Bytes:** 13876
...
- **[FACT]** This source file contains 797 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 13876 bytes; 797 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting chat/chat_view/chat-v.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: chat/chat_view/chat-v.css.

---

# SOURCE CODE

> Source: `chat/chat_view/chat-v.css`
...
.chatMessages{
  ...
  padding:14px 10px;
  padding-bottom:120px;   /*  BIG SPACE */
...
.chatMessages::after{
  content:"";
  height:40px;   /*  FINAL PUSH SPACE */
  flex-shrink:0;
}

/* ================================
   INPUT INTERACTIONS (ULTRA PREMIUM)
================================ */
...
/*  ACTIVE PRESS (REAL TOUCH FEEL) */
.chatInputWrapper:active{
...
.chatInputWrapper{
  ...
  /*  SAFE FALLBACK BACKGROUND (NO GLITCH) */
  ...
  /*  IMPORTANT FIX (NO GLITCH) */
  transform: translateZ(0);
  will-change: transform;

  /*  PRE-RENDER FIX (NO FIRST FRAME GLITCH) */
  opacity: 0;
  animation: fixRender 0.2s ease forwards;

  transition:all 0.2s ease;
}

/*  APPLY BLUR ONLY IF SUPPORTED (SAFE MODE) */
@supports (backdrop-filter: blur(12px)) {
  .chatInputWrapper{
    backdrop-filter: blur(12px);
    -webkit-backdrop-filter: blur(12px);

    /* slightly transparent when blur works */
...
.chatInput{
  ...
  overflow-y:auto;          /* scroll after limit */
...
/*  SCROLLBAR CLEAN (OPTIONAL PRO TOUCH) */
...
.msgMenu{
  ...
  /*  DEPTH FIX (LESS DIRTY SHADOW) */
  box-shadow:
    0 8px 24px rgba(0,0,0,0.5),
    inset 0 1px 0 rgba(255,255,255,0.04);

  /*  SIZE STABILITY (IMPORTANT FIX) */
  min-width:140px;
