...
- **File Name:** `regular.min.js`
- **File Path:** `fontawesome/js/regular.min.js`
- **Extension:** `.js`
- **Lines:** 6
- **Bytes:** 114539
...
- **[INFERRED]** Static size: 114539 bytes; 6 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/js/regular.min.js, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/js/regular.min.js.

---

# SOURCE CODE

> Source: `fontawesome/js/regular.min.js`
