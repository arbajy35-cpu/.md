...
- **File Name:** `regular.js`
- **File Path:** `fontawesome/js/regular.js`
- **Extension:** `.js`
- **Lines:** 454
- **Bytes:** 121389
...
- **[FACT]** This source file contains 454 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 121389 bytes; 454 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/js/regular.js, then inspect its incoming and outgoing dependency relationships.
...
- `ownKeys` — line 26
- `_objectSpread2` — line 39
- `_defineProperty` — line 52
- `_toConsumableArray` — line 67
- `_arrayWithoutHoles` — line 71
- `_iterableToArray` — line 75
- `_unsupportedIterableToArray` — line 79
- `_arrayLikeToArray` — line 88
- `_nonIterableSpread` — line 96
- `familyProxy` — line 114
- `get` — line 117
- `bunker` — line 222
- `normalizeIcons` — line 243
- `defineIcons` — line 258
...
Source file: fontawesome/js/regular.js.

---

# SOURCE CODE

> Source: `fontawesome/js/regular.js`
