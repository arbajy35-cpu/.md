...
- **File Name:** `v4-shims.js`
- **File Path:** `fontawesome/js/v4-shims.js`
- **Extension:** `.js`
- **Lines:** 234
- **Bytes:** 33929
...
- **[FACT]** This source file contains 234 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 33929 bytes; 234 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/js/v4-shims.js, then inspect its incoming and outgoing dependency relationships.
...
- `_defineProperty` — line 29
- `_toConsumableArray` — line 44
- `_arrayWithoutHoles` — line 48
- `_iterableToArray` — line 52
- `_unsupportedIterableToArray` — line 56
- `_arrayLikeToArray` — line 65
- `_nonIterableSpread` — line 73
- `familyProxy` — line 91
- `get` — line 94
- `bunker` — line 199
...
Source file: fontawesome/js/v4-shims.js.

---

# SOURCE CODE

> Source: `fontawesome/js/v4-shims.js`
