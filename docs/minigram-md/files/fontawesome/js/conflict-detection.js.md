...
- **File Name:** `conflict-detection.js`
- **File Path:** `fontawesome/js/conflict-detection.js`
- **Extension:** `.js`
- **Lines:** 1147
- **Bytes:** 39658
...
- **[FACT]** This source file contains 1147 lines and is part of the MiniGram source tree.
...
- **[FACT]** https://fontawesome.com,https://fontawesome.com/license/free
...
- **[INFERRED]** Static size: 39658 bytes; 1147 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/js/conflict-detection.js, then inspect its incoming and outgoing dependency relationships.
...
- `ownKeys` — line 12
- `_objectSpread2` — line 25
- `_typeof` — line 38
- `_defineProperty` — line 48
- `_toConsumableArray` — line 63
- `_arrayWithoutHoles` — line 67
- `_iterableToArray` — line 71
- `_unsupportedIterableToArray` — line 75
- `_arrayLikeToArray` — line 84
- `_nonIterableSpread` — line 92
- `listener` — line 115
- `domready` — line 130
- `report` — line 135
- `createCommonjsModule` — line 203
- `safeAdd` — line 219
- `lsw` — line 220
- `msw` — line 221
- `bitRotateLeft` — line 233
- `md5cmn` — line 249
- `md5ff` — line 266
- `md5gg` — line 283
- `md5hh` — line 300
...
- `rstr2binl` — line 448
- `rstrMD5` — line 473
- `rstrHMACMD5` — line 485
- `rstr2hex` — line 513
- `str2rstrUTF8` — line 534
- `rawMD5` — line 545
- `hexMD5` — line 556
- `rawHMACMD5` — line 568
- `hexHMACMD5` — line 580
- `md5` — line 595
- `md5ForNode` — line 619
- `silenceErrors` — line 641
- `pollUntil` — line 646
- `poll` — line 660
- `detectWebfontConflicts` — line 688
- `runDiag` — line 707
- `diagScriptFun` — line 725
- `fn` — line 727
- `detectSvgConflicts` — line 807
- `_loop` — line 813
- `diagScriptFun` — line 835
- `fn` — line 837
- `setDoneResults` — line 887
- `conflictDetection` — line 896
- `fn` — line 944
- `familyProxy` — line 1018
- `get` — line 1021
- `bunker` — line 1126
- `DOMContentLoaded` — line 127
- `error` — line 770
- `error` — line 870
...
Source file: fontawesome/js/conflict-detection.js.

---

# SOURCE CODE

> Source: `fontawesome/js/conflict-detection.js`
