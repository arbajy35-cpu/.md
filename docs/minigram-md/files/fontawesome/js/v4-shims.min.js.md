...
- **File Name:** `v4-shims.min.js`
- **File Path:** `fontawesome/js/v4-shims.min.js`
- **Extension:** `.js`
- **Lines:** 6
- **Bytes:** 27657
...
- **[INFERRED]** Static size: 27657 bytes; 6 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/js/v4-shims.min.js, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/js/v4-shims.min.js.

---

# SOURCE CODE

> Source: `fontawesome/js/v4-shims.min.js`
