...
- **File Name:** `v4-shims.min.css`
- **File Path:** `fontawesome/css/v4-shims.min.css`
- **Extension:** `.css`
- **Lines:** 6
- **Bytes:** 27593
...
- **[INFERRED]** Static size: 27593 bytes; 6 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/css/v4-shims.min.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/css/v4-shims.min.css.

---

# SOURCE CODE

> Source: `fontawesome/css/v4-shims.min.css`
