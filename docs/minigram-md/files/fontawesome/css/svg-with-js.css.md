...
- **File Name:** `svg-with-js.css`
- **File Path:** `fontawesome/css/svg-with-js.css`
- **Extension:** `.css`
- **Lines:** 641
- **Bytes:** 21702
...
- **[FACT]** This source file contains 641 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 21702 bytes; 641 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/css/svg-with-js.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/css/svg-with-js.css.

---

# SOURCE CODE

> Source: `fontawesome/css/svg-with-js.css`
