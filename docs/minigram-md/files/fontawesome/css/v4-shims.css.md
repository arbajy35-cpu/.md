...
- **File Name:** `v4-shims.css`
- **File Path:** `fontawesome/css/v4-shims.css`
- **Extension:** `.css`
- **Lines:** 2195
- **Bytes:** 41574
...
- **[FACT]** This source file contains 2195 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 41574 bytes; 2195 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/css/v4-shims.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/css/v4-shims.css.

---

# SOURCE CODE

> Source: `fontawesome/css/v4-shims.css`
