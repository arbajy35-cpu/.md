...
- **File Name:** `svg-with-js.min.css`
- **File Path:** `fontawesome/css/svg-with-js.min.css`
- **Extension:** `.css`
- **Lines:** 6
- **Bytes:** 17017
...
- **[INFERRED]** Static size: 17017 bytes; 6 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/css/svg-with-js.min.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/css/svg-with-js.min.css.

---

# SOURCE CODE

> Source: `fontawesome/css/svg-with-js.min.css`
