...
- **File Name:** `fontawesome.css`
- **File Path:** `fontawesome/css/fontawesome.css`
- **Extension:** `.css`
- **Lines:** 6370
- **Bytes:** 113367
...
- **[FACT]** This source file contains 6370 lines and is part of the MiniGram source tree.
...
- **[INFERRED]** Static size: 113367 bytes; 6370 lines. Runtime performance requires profiling for reliable measurement.
...
- **[INFERRED]** Start by inspecting fontawesome/css/fontawesome.css, then inspect its incoming and outgoing dependency relationships.
...
Source file: fontawesome/css/fontawesome.css.

---

# SOURCE CODE

> Source: `fontawesome/css/fontawesome.css`
